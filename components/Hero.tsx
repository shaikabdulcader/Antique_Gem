...
export default function Hero() {
    return (
        <section className="relative h-[85vh] w-full overflow-hidden flex items-center justify-center bg-transparent">
            ...
            <div className="mx-auto w-[90%] max-w-7xl px-8 h-full flex flex-col justify-center relative z-10 pt-[8vh]">
                {/* Content */}
                <motion.div
                ...
                >
                    ...
                    <p className="text-lg md:text-xl font-normal leading-[1.6] tracking-normal text-white/90 max-w-2xl">
